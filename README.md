...
- 🔗 [Shortify](https://github.com/Pradhansumit/Shortify) – URL shortener with hash-based uniqueness
- 📧 [MailBlast](https://github.com/Pradhansumit/MailBlast) – Bulk email sender to your subscribers
- 🎬 [MovieCLI](https://github.com/Pradhansumit/MovieCLI) – CLI tool for movie details
- 🧑‍💼 [StaffFlow](https://github.com/Pradhansumit/StaffFlow) – Employee management app with React + Django
- 🔐 [Django_JWT](https://github.com/Pradhansumit/Django_JWT) – JWT auth with SimpleJWT
